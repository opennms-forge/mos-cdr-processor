 ...
 * Due to some limitations within the onejar bootstrapping, we have to provide our own LogAdapter
 * to be used within the "library" of the moscdrprocessor implementations.
